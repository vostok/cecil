...
namespace Mono.Cecil {
	...
	public class MetadataResolver : IMetadataResolver {
		...
		internal static bool AreSame (MethodReference method, MethodReference reference)
		{
		...
		private static bool IsVarArgCallTo (MethodReference method, MethodReference reference)
		{
